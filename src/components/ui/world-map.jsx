...
export default function WorldMap({ dots, lineColor = "#4CAF50" }) {
    ...
    return (
        <div className="w-full relative aspect-[2/1] bg-transparent">
            <svg
                ref={svgRef}
                viewBox="0 0 800 400"
            ...
            >
                ...
                {dots.map((dot, i) => {
                    ...
                    // Quadratic bezier calc
                    const dx = end.x - start.x;
                    const dy = end.y - start.y;
                    const dist = Math.sqrt(dx * dx + dy * dy);
                    const midX = (start.x + end.x) / 2;
                    const midY = (start.y + end.y) / 2 - (dist * 0.2); // Arch height
                        ...
                        <g key={i}>
                            ...
                            <circle r="3" fill="#fff" filter="url(#glow)">
                                <animateMotion
                                    ...
                                    path={pathData}
                                    begin={`${i * 0.5}s`} // Staggered start
                                />
                            </circle>

                            {/* Start Point Pulse */}
                            <circle cx={start.x} cy={start.y} r="2" fill={lineColor} fillOpacity="0.8" />
                            <motion.circle
                            ...
                            />
                            <circle cx={end.x} cy={end.y} r="2" fill={lineColor} fillOpacity="0.8" />
                        </g>
                    )
                })}
                <defs>
